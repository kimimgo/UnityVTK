...
public class VTKRoot : MonoBehaviour
{
	...
	{
		VTKNode node = activeNode.AddChild (new VTKNode ((VTKFilter)UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent (gameObject, "Assets/VTK/VTKRoot.cs (173,63)", filterName), 
